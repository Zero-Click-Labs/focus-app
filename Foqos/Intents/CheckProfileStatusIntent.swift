...
struct CheckProfileStatusIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "MindPower Profile Status"
  static var description = IntentDescription(
    "Check if a MindPower profile is currently active and return the status as a boolean value.")
