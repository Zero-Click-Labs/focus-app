...
struct StartProfileIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Start MindPower Profile"

  static var description = IntentDescription(
    "Start a MindPower blocking profile. Optionally specify a timer duration in minutes (15-1440)."
  )
